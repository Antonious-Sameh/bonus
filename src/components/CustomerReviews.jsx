...
const REVIEWS = [
  ...
  },
  {
    ...
    date: "منذ أسبوعين",
    rating: 5,
    text: "الخدمة سريعة والأسعار معقولة مقارنة بأي محل تاني في المنطقة. بجد مش هتندم لو اشتريت منهم، وبيردوا على الاستفسارات بسرعة كمان.",
  },
  {
    id: 3,
    initial: "س",
  ...
  },
  {
    ...
    date: "منذ شهر",
    rating: 5,
    text: "اشتريت آيفون وتعامل الموظفين كان محترم جداً وشرحولي كل حاجة. المحل نظيف ومنظم والبضاعة معروضة بشكل كويس. هرشحه لأي حد.",
  },
  {
    id: 5,
    initial: "ح",
    ...
    date: "منذ شهر",
    rating: 5,
    text: "أحسن محل إلكترونيات في المنطقة. جربت أشتري من محلات تانية بس رجعت هنا. الأمانة والأسعار المناسبة دي أهم حاجة بالنسبالي.",
  },
  {
    id: 6,
    initial: "ف",
