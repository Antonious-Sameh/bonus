...
const REVIEWS = [
  {
    ...
    date: "منذ أسبوع",
    rating: 5,
    text: "محل محترم جداً  نظام النقاط ده حلو برضو، كسبت نقاط وصرفتهم في شراية جديدة 👍",
  },
  {
    id: 2,
    initial: "أ",
...
function ReviewCard({ review }) {
  ...
  return (
    <div
      className="relative rounded-2xl p-4 flex flex-col gap-3 w-full h-full"
      style={{
        background: "hsl(24 7% 11%)",
        border: "1px solid rgba(255,255,255,0.07)",
      }}
    >
      {/* علامة اقتباس */}
      <div
        className="absolute top-3 left-3 w-6 h-6 flex items-center justify-center rounded-lg opacity-35"
        ...
        {REVIEWS.map((_, i) => (
          <button
            ...
            style={{
              ...
              height: "6px",
              background:
                i === idx ? "hsl(43 85% 58%)" : "rgba(255,255,255,0.15)",
            }}
          />
        ))}
      </div>
